#include "analysis/LibraryInfoCollector.h"
...
{
    argDepMap.emplace(index, LibArgDepInfo{input_dependency::InputDepInfo::INPUT_INDEP});
}
...
{
    argDepMap.emplace(index, LibArgDepInfo{input_dependency::InputDepInfo::ARG_DEP, std::move(deps)});
}
