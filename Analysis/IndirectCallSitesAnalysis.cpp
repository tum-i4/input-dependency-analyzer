...
void IndirectCallSitesAnalysisResult::addIndirectCallTarget(llvm::CallInst* call, llvm::Function* target)
{
...
{
    return m_indirectCallTargets.find(invoke) != m_indirectCallTargets.end();
}
