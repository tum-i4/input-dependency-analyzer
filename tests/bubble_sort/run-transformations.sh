...
#clone
opt -load $LOCAL_LIB_LOC/libInputDependency.so -load $LOCAL_LIB_LOC/libTransforms.so bubble_sort.bc -clone-functions -o clone.bc

#extract
opt -load $LOCAL_LIB_LOC/libInputDependency.so -load $LOCAL_LIB_LOC/libTransforms.so bubble_sort.bc -extract-functions -o extract.bc
...
llvm-dis bubble_sort.bc
llvm-dis clone.bc
llvm-dis extract_on_clone.bc
#llvm-dis clone_on_extract.bc

clang bubble_sort.bc -lncurses -o bubble_sort
